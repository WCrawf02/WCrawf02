...
| NMap scanning     | Network monitoring tool for detecting anomalies | Python, Wireshark, Machine Learning | [NMap](https://github.com/WCrawf02/Security-Toolbox/blob/main/nmap.py)|
